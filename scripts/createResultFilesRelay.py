...
for path, dirnames, filenames in os.walk(dir + '/relay'):
    print(path)
...
columns = ['Scenario', 'Interests', 'Satisfied', 'TimedOut']
...
for file in filelist:
    ...
    dfResult.loc[index] = [strategyName, totalInterests, satisfiedInterests, timedoutInterests]
    index = index + 1

print(dfResult)


dfResult.to_csv(f'finalResults/relays.txt', sep='\t', index=False)
